...
- [x] US-126: Add horizontal ruler - P3 - Ruler with margin markers
- [x] US-127: Add print preview/export - P3 - Print with correct layout
...
- [x] US-132: Wire table row deletion - P1 - Delete selected rows
...
- [x] US-154: Improve keyboard navigation - P2 - Ctrl+Arrow, Home/End
...
- [x] US-162: Add unsaved changes indicator - P3 - Show unsaved status
- [x] US-163: Add auto-save functionality - P3 - Auto-save to localStorage
